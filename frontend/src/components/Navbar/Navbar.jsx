      ...
      <div ref={menuRef} className="relative">
        ...
        >
          ...
          <button
            ...
            disabled={uploading}
            className="w-full flex items-center gap-3 px-5 py-4 hover:bg-[#2d2e30] transition disabled:opacity-50"
          >
            📷
          ...
          {/* Settings */}
          <button className="w-full flex items-center gap-3 px-5 py-4 hover:bg-[#2d2e30] transition">
            <FaCog />
